// src/components/Dashboard/InventoryClerkDashboard.js
...
const InventoryClerkDashboard = ({ user }) => {
  ...
  const getActivityColor = (type) => {
    switch (type) {
      case 'stock_in': return 'bg-green-100 text-green-600';
      case 'stock_out': return 'bg-blue-100 text-blue-600';
      ...
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {[
              { name: 'Scan Item', icon: QrCode, href: '/inventory/scan', color: 'bg-blue-600 hover:bg-blue-700' },
              { name: 'Add Stock', icon: Plus, href: '/inventory/add', color: 'bg-green-600 hover:bg-green-700' },
              { name: 'Issue Items', icon: Minus, href: '/inventory/issue', color: 'bg-orange-600 hover:bg-orange-700' },
              { name: 'Search Items', icon: Search, href: '/inventory/search', color: 'bg-purple-600 hover:bg-purple-700' },
              { name: 'Reports', icon: BarChart3, href: '/reports', color: 'bg-indigo-600 hover:bg-indigo-700' },
              { name: 'Settings', icon: Settings, href: '/settings', color: 'bg-gray-600 hover:bg-gray-700' }
            ].map((action) => (
              <Link
                key={action.name}
                to={action.href}
        ...
        {data.lowStockItems.length > 0 && (
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/inventory/low-stock" className="text-sm text-blue-600 hover:text-blue-700 font-medium">
                View all →
              </Link>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/inventory/activity" className="text-sm text-blue-600 hover:text-blue-700 font-medium">
                View all →
              </Link>
            </div>
            <div className="space-y-4">
                  ...
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-500">
                        Due: {formatDate(task.dueDate)} • Est: {task.estimatedTime}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
